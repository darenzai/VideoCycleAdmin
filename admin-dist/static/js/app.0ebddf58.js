(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app"], {
    0: function (e, t, n) {
        ...
        "use strict";
        n.r(t);
        var a = n("e017"), i = n.n(a), o = n("21a1"), r = n.n(o), c = new i.a({
            id: "icon-link",
            use: "icon-link-usage",
            viewBox: "0 0 128 128",
        ...
        "use strict";
        var a = n("2b0e"), i = n("2f62"), o = (n("b0c0"), {
                sidebar: function (e) {
            ...
            }), r = o, c = n("a78e"), s = n.n(c), u = {
                sidebar: {opened: !s.a.get("sidebarStatus") || !!+s.a.get("sidebarStatus"), withoutAnimation: !1},
                device: "desktop"
            }, l = {
            ...
            }, m = {namespaced: !0, state: u, mutations: l, actions: d}, h = n("83d6"), f = n.n(h), p = f.a.showSettings,
            v = f.a.fixedHeader, b = f.a.sidebarLogo, g = {showSettings: p, fixedHeader: v, sidebarLogo: b}, w = {
            ...
            }, k = {namespaced: !0, state: g, mutations: w, actions: x}, y = (n("d3b7"), n("498a"), n("b775")),
            C = n("5f87");

        function _(e) {
            return Object(y["a"])({url: "/tokens", method: "post", data: e})
        }

        function O(e) {
            return Object(y["a"])({url: "/admin-user", method: "get", params: {token: e}})
        }

        function z() {
            return Object(y["a"])({url: "/tokens/".concat(Object(C["a"])()), method: "delete"})
        }

        var E = n("a18c"), S = function () {
            return {token: Object(C["a"])(), name: "", avatar: ""}
        }, H = S(), T = {
            ...
            login: function (e, t) {
                ...
                return new Promise((function (e, t) {
                    _({username: a.trim(), password: i}).then((function (t) {
                        var a = t.data;
                ...
                return new Promise((function (e, a) {
                    z(n.token).then((function () {
                        Object(C["b"])(), Object(E["b"])(), t("RESET_STATE"), e()
                    })).catch((function (e) {
                        a(e)
                    }))
                }))
        ...
        }, M = {namespaced: !0, state: H, mutations: T, actions: B};
        a["default"].use(i["a"]);
        var j = new i["a"].Store({modules: {app: m, settings: k, user: M}, getters: r});
        t["a"] = j
    }, "47f1": function (e, t, n) {
        "use strict";
        n.r(t);
        ...
        var a = n("2b0e"), i = (n("f5df1"), n("5c96")), o = n.n(i), r = (n("0fae"), n("b20f"), function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
                return n("div", {attrs: {id: "app"}}, [n("router-view")], 1)
            }), c = [], s = {name: "App"}, u = s, l = (n("034f"), n("2877")),
            d = Object(l["a"])(u, r, c, !1, null, null, null), m = d.exports, h = n("4360"), f = n("a18c"),
            p = (n("d81d"), n("d3b7"), n("ddb0"), function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
                ...
                computed: {
                    isExternal: function () {
                        return Object(b["a"])(this.iconClass)
                    }, iconName: function () {
            ...
            }, w = g, x = (n("68fa"), Object(l["a"])(w, p, v, !1, null, "f9f7fefc", null)), k = x.exports;
        a["default"].component("svg-icon", k);
        var y = n("51ff"), C = function (e) {
            return e.keys().map(e)
        };
        C(y);
        n("c975"), n("b0c0"), n("96cf");
        var _ = n("1da1"), O = n("323e"), z = n.n(O), E = (n("a5d8"), n("5f87")), S = (n("99af"), n("83d6")),
            H = n.n(S), T = H.a.title || "Vue Admin Template";

        function B(e) {
            return e ? "".concat(e, " - ").concat(T) : "".concat(T)
        }

        z.a.configure({showSpinner: !1});
        var M = ["/login"];
        f["a"].beforeEach(function () {
            var e = Object(_["a"])(regeneratorRuntime.mark((function e(t, n, a) {
                var o, r;
                return regeneratorRuntime.wrap((function (e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            if (z.a.start(), document.title = B(t.meta.title), o = Object(E["a"])(), !o) {
                                e.next = 29;
                                break
                            }
                            if ("/login" !== t.path) {
                            ...
                            a({path: "/"}), z.a.done(), e.next = 27;
                            break;
                        case 9:
                            if (r = h["a"].getters.name, !r) {
                                e.next = 14;
                                break
                            }
                            a(), e.next = 27;
                            break;
                        case 14:
                            return e.prev = 14, e.next = 17, h["a"].dispatch("user/getInfo");
                        case 17:
                            a(), e.next = 27;
                            break;
                        case 20:
                            return e.prev = 20, e.t0 = e["catch"](14), e.next = 24, h["a"].dispatch("user/resetToken");
                        case 24:
                            i["Message"].error(e.t0 || "Has Error"), a("/login?redirect=".concat(t.path)), z.a.done();
                        case 27:
                            e.next = 30;
                            break;
                        case 29:
                            -1 !== M.indexOf(t.path) ? a() : (a("/login?redirect=".concat(t.path)), z.a.done());
                        case 30:
                        case"end":
                            return e.stop()
                    }
            ...
            z.a.done()
        })), a["default"].use(o.a), a["default"].config.productionTip = !1, new a["default"]({
            el: "#app",
            router: f["a"],
            store: h["a"],
            render: function (e) {
        ...
        var a = n("a78e"), i = n.n(a), o = "vue_admin_template_token";
        ...
        n("d3b7");
        var a, i, o = n("2b0e"), r = n("8c4f"), c = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
                return n("div", {
            ...
            }, l = [], d = (n("96cf"), n("1da1")), m = n("5530"), h = n("2f62"), f = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, p = [], v = (n("99af"), n("4de4"), n("b0c0"), n("498a"), n("bd11")), b = n.n(v), g = {
                data: function () {
                    ...
                    getBreadcrumb: function () {
                        ...
                        var t = this.$route.params, n = b.a.compile(e);
                        return n(t)
            ...
            }, w = g, x = (n("0c00"), n("2877")), k = Object(x["a"])(w, f, p, !1, null, "4c29ea56", null), y = k.exports,
            C = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
                return n("div", {
            ...
            }, z = O, E = (n("186a"), Object(x["a"])(z, C, _, !1, null, "49e15297", null)), S = E.exports, H = {
                components: {Breadcrumb: y, Hamburger: S},
                computed: Object(m["a"])({}, Object(h["b"])(["sidebar", "avatar"])),
                methods: {
            ...
            }, T = H, B = (n("ea2c"), Object(x["a"])(T, u, l, !1, null, "050d8c75", null)), M = B.exports, j = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, I = $, N = (n("6b31"), Object(x["a"])(I, A, L, !1, null, "5bb1c0e2", null)), P = N.exports, D = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, R = [], q = n("df7c"), G = n.n(q), U = n("61f7"), J = (n("caad"), n("2532"), {
                name: "MenuItem",
                functional: !0,
                props: {icon: {type: String, default: ""}, title: {type: String, default: ""}},
                render: function (e, t) {
                    var n = t.props, a = n.icon, i = n.title, o = [];
                    return a && (a.includes("el-icon") ? o.push(e("i", {class: [a, "sub-el-icon"]})) : o.push(e("svg-icon", {attrs: {"icon-class": a}}))), i && o.push(e("span", {slot: "title"}, [i])), o
                }
            }), F = J, K = (n("bf4f"), Object(x["a"])(F, a, i, !1, null, "18eeea00", null)), W = K.exports,
            Q = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, Z = Y, ee = Object(x["a"])(Z, Q, X, !1, null, null, null), te = ee.exports, ne = {
                computed: {
                    device: function () {
                ...
                methods: {
                    hasOneShowingChild: function () {
                        ...
                        return 1 === a.length || 0 === a.length && (this.onlyOneChild = Object(m["a"])(Object(m["a"])({}, n), {}, {
                            path: "",
                            noShowingChildren: !0
                        }), !0)
                    }, resolvePath: function (e) {
                        return Object(U["a"])(e) ? e : Object(U["a"])(this.basePath) ? this.basePath : G.a.resolve(this.basePath, e)
                    }
                }
            }, ie = ae, oe = Object(x["a"])(ie, D, R, !1, null, null, null), re = oe.exports, ce = n("cf1e"), se = n.n(ce),
            ue = {
                components: {SidebarItem: re, Logo: P},
                computed: Object(m["a"])(Object(m["a"])({}, Object(h["b"])(["sidebar"])), {}, {
                    routes: function () {
            ...
            }, le = ue, de = Object(x["a"])(le, j, V, !1, null, null, null), me = de.exports, he = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            }, ve = pe, be = (n("e4de"), n("028b"), Object(x["a"])(ve, he, fe, !1, null, "64cf4d83", null)),
            ge = be.exports, we = n("4360"), xe = document, ke = xe.body, ye = 992, Ce = {
                watch: {
                    $route: function (e) {
                        "mobile" === this.device && this.sidebar.opened && we["a"].dispatch("app/closeSideBar", {withoutAnimation: !1})
                    }
                    ...
                    e && (we["a"].dispatch("app/toggleDevice", "mobile"), we["a"].dispatch("app/closeSideBar", {withoutAnimation: !0}))
                }, methods: {
                    $_isMobile: function () {
                        ...
                        if (!document.hidden) {
                            var e = this.$_isMobile();
                            we["a"].dispatch("app/toggleDevice", e ? "mobile" : "desktop"), e && we["a"].dispatch("app/closeSideBar", {withoutAnimation: !0})
                        }
                    }
                }
            }, _e = {
                name: "Layout",
                components: {Navbar: M, Sidebar: me, AppMain: ge},
                mixins: [Ce],
                computed: {
                    sidebar: function () {
            ...
            }, Oe = _e, ze = (n("9f2b"), Object(x["a"])(Oe, c, s, !1, null, "4f739cf0", null)), Ee = ze.exports;
        o["default"].use(r["a"]);
        var Se = [{
            path: "/login", component: function () {
                return n.e("chunk-44ae20f8").then(n.bind(null, "9ed6"))
            }, hidden: !0
        }, {
            ...
            children: [{
                path: "dashboard", name: "Dashboard", component: function () {
                    return n.e("chunk-c681cc98").then(n.bind(null, "9406"))
                }, meta: {title: "控制面板", icon: "dashboard"}
            }]
        }, {
            path: "/category", component: Ee, children: [{
                path: "", name: "Category", component: function () {
                    return n.e("chunk-00c0d46f").then(n.bind(null, "8fce"))
                }, meta: {title: "分类", icon: "el-icon-refrigerator"}
            }]
        }, {
            path: "/user", component: Ee, children: [{
                path: "", name: "User", component: function () {
                    return n.e("chunk-7346b5ce").then(n.bind(null, "a547"))
                }, meta: {title: "用户", icon: "el-icon-user"}
            }]
        }, {
            path: "/video", component: Ee, children: [{
                path: "", name: "Video", component: function () {
                    return n.e("chunk-748f773e").then(n.bind(null, "e001"))
                }, meta: {title: "视频", icon: "el-icon-video-camera"}
            }]
        }, {path: "*", redirect: "/404", hidden: !0}], He = function () {
            return new r["a"]({
        ...
        "use strict";
        n("4160"), n("b64b"), n("d3b7"), n("159b");
        var a = n("bc3a"), i = n.n(a), o = n("5c96"), r = n("4360"), c = n("5f87"), s = i.a.create({
            baseURL: "http://10.15.0.3:9999/admin", timeout: 5e3, validateStatus: function () {
                return !0
            }
        });
        s.interceptors.request.use((function (e) {
            return e.params = e.params || {}, Object.keys(e.params).forEach((function (t) {
                "" === e.params[t] && (e.params[t] = void 0)
            })), r["a"].getters.token && (e.params["token"] = Object(c["a"])()), e
        }), (function (e) {
            return console.log(e), Promise.reject(e)
        })), s.interceptors.response.use((function (e) {
            if (null != e.data["err_msg"]) {
                var t = e.data["err_code"];
                401 === t ? o["MessageBox"].confirm("您已退出登录, 您可以点击取消以留在本页, 或重新登录", "Confirm logout", {
                ...
                })) : o["Notification"].error({title: "错误", message: e.data["err_msg"], duration: 5e3})
            }
            return e
        }), (function (e) {
            return console.log("err" + e), o["Notification"].error({
                title: "错误",
